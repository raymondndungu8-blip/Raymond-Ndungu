            ...
            <Reveal key={item.name} as="div">
              <article className="group overflow-hidden rounded-3xl bg-white shadow-soft ring-1 ring-forest/5">
                <div className="relative aspect-[4/3] overflow-hidden">
                  <Image src={item.image} alt={item.name} fill sizes="(max-width:768px) 100vw, 33vw" className="object-cover transition-transform duration-700 group-hover:scale-110" />
                </div>
